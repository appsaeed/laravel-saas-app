...
// mix.combine([
//   'resources/js/scripts/laravel-echo.js',
//   'resources/js/scripts/pusher.js'
// ], 'resources/js/scripts/pusher-echo.js')

mix
  .js('resources/js/core/app-menu.js', 'public/js/core')
  .js('resources/js/core/app.js', 'public/js/core')
  .js('resources/js/scripts/echo.js', 'public/js/scripts')
