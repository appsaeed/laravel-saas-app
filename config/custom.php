...
return [
        'vertical' => [
                ...
                'defaultLanguage'        => env('APP_LOCALE'),    //en(default)/de/pt/fr here are four optional language provided in theme
        ...
        'theme_skin' => env('THEME_SKIN', 'dark'),

        'menu' => [
                'language_menu'         => env('THEME_LANGUE_MENU', true),
                'theme_switch'          => env('THEME_SWITCH_MENU', true),
                'profile_menu'          => env('THEME_PROFILE_MENU', true),
                'notifye_menu'          => env('THEME_NOTIFYE_MENU', true)
        ]
];
