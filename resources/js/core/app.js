...
(function (window, document, $) {
  ...
  bookmarkStar.on("click", function (e) {
    ...
    for (var i = 0; i < arrList.length; i++) {
      ...
      $arrList += '<li class="auto-suggestion ' + $activeItemClass + '">' + '<a class="d-flex align-items-center justify-content-between w-100" href=' + arrList[i].firstChild.href + ">" + '<div class="d-flex justify-content-start align-items-center">' + feather.icons[iconName].toSvg({ class: "me-75 " + className }) + "<span>" + arrList[i].firstChild.dataset.bsOriginalTitle + "</span>" + "</div>" + feather.icons["star"].toSvg({ class: "text-warning bookmark-icon float-end" }) + "</a>" + "</li>";
    }
      ...
      if (value != "") {
        ...
        $.getJSON(assetPath + "data/" + $filename + ".json", function (data) {
          for (var i = 0; i < data.listItems.length; i++) {
            ...
            if (data.listItems[i].name.toLowerCase().indexOf(value) == 0 && a < 5) {
              ...
              $startList += '<li class="auto-suggestion ' + $activeItemClass + '">' + '<a class="d-flex align-items-center justify-content-between w-100" href=' + data.listItems[i].url + ">" + '<div class="d-flex justify-content-start align-items-center">' + feather.icons[data.listItems[i].icon].toSvg({ class: "me-75 " }) + "<span>" + data.listItems[i].name + "</span>" + "</div>" + $bookmarkIcon + "</a>" + "</li>";
              a++;
            }
          }
          for (var i = 0; i < data.listItems.length; i++) {
            ...
            if (!(data.listItems[i].name.toLowerCase().indexOf(value) == 0) && data.listItems[i].name.toLowerCase().indexOf(value) > -1 && a < 5) {
              ...
              $otherList += '<li class="auto-suggestion ' + $activeItemClass + '">' + '<a class="d-flex align-items-center justify-content-between w-100" href=' + data.listItems[i].url + ">" + '<div class="d-flex justify-content-start align-items-center">' + feather.icons[data.listItems[i].icon].toSvg({ class: "me-75 " }) + "<span>" + data.listItems[i].name + "</span>" + "</div>" + $bookmarkIcon + "</a>" + "</li>";
              a++;
            }
          }
        ...
        if (bookmark === true) {
          ...
          for (var i = 0; i < arrList.length; i++) {
            ...
            $arrList += '<li class="auto-suggestion">' + '<a class="d-flex align-items-center justify-content-between w-100" href=' + arrList[i].firstChild.href + ">" + '<div class="d-flex justify-content-start align-items-center">' + feather.icons[iconName].toSvg({ class: "me-75 " }) + "<span>" + arrList[i].firstChild.dataset.bsOriginalTitle + "</span>" + "</div>" + feather.icons["star"].toSvg({ class: "text-warning bookmark-icon float-end" }) + "</a>" + "</li>";
          }
          $("ul.search-list").append($arrList);
          // Feather Icons
          // if (feather) {
  ...
  $(document).on("click", ".bookmark-input .search-list .bookmark-icon", function (e) {
    ...
    if ($(this).hasClass("text-warning")) {
      ...
      $listItem = '<li class="nav-item d-none d-lg-block">' + '<a class="nav-link" href="' + $url + '" data-bs-toggle="tooltip" data-bs-placement="bottom" title="' + $name + '">' + feather.icons[iconName].toSvg({ class: "ficon" }) + "</a>" + "</li>";
...
window.actionButtons = function (full) {
  let action = '';

  if (full['can_chat']) {
    action += '<a href="' + full['chat_url'] +
      '" class="pe-1 text-success"  title="open messages">' +
  ...
  if (full['can_update']) {
    action += '<a href="' + full['edit'] +
      '" class="pe-1 text-primary" title="action to update">' +
  ...
  if (full['can_view']) {
    action += '<a href="' + full['view'] +
      '" class="pe-1 text-primary" title="action to view">' +
  ...
  if (full['can_delete']) {
    action +=
      '<span class="action-delete text-danger cursor-pointer"  title="action to delete" data-id=' +
      full['delete'] + '>' +
