                ...
                <div class="width-1200 mx-auto">
                    <div class="bs-stepper register-multi-steps-wizard shadow-none">
                        <div class="bs-stepper-header px-0" role="tablist">
                            ...
                            <div class="step" data-target="#environment-settings" role="tab"
                                id="environment-settings-trigger">
                                <button type="button" class="step-trigger">
                                    <span class="bs-stepper-box">
                            ...
                            <div class="step" data-target="#profile-settings" role="tab"
                        ...
                        <div class="bs-stepper-content px-0 mt-4">
                            ...
                            <div id="environment-settings" class="content get_form_data" role="tabpanel"
                                aria-labelledby="environment-settings-trigger">
                                <form id="environment_form">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="text" id="app_name" class="form-control" name="app_name"
                                                required value="{{ config('app.name') }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-8">
                                            ...
                                            <input type="text" id="app_url" class="form-control" name="app_url"
                                                value="{{ rtrim(request()->url(), 'install') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label required" for="database-connection">Database
                                                Connection</label>
                                            <select name="database_connection" id="database-connection"
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-8">
                                            ...
                                            <input type="text" id="database_name" class="form-control"
                                                name="database_name" required value="{{ env('DB_DATABASE') }}" />
                                        </div>
                                        <div class="mb-1 col-md-4">
                                            <label class="form-label" for="database_prefix">Database Prefix</label>
                                            <input type="text" id="database_prefix" class="form-control"
                                                value="{{ env('DB_PREFIX', 'cg_') }}" name="database_prefix" />
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label required" for="database_user_name">Database
                                                Username</label>
                                            <input type="text" id="database_user_name" class="form-control"
                                                name="database_username" value="{{ env('DB_USERNAME') }}" />
                                        </div>

                                        <div class="mb-1 col-md-6">
                                            <label class="form-label required" for="database_password">Database
                                                Password</label>
                                            <input type="password" id="database_password" class="form-control"
                                                name="database_password" value="{{ env('DB_PASSWORD') }}" />
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        ...
                                        <button class="btn btn-primary btn-save" type="submit">
                                            <span
                                                class="align-middle d-sm-inline-block d-none">{{ __('locale.buttons.save') }}</span>
                            ...
                            <div id="profile-settings" class="content" role="tabpanel"
                                aria-labelledby="profile-settings-trigger">
                                <form id="profile_form">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-12">
                                            ...
                                            <input type="text" id="admin_path" class="form-control" value="admin"
                                                required name="admin_path" />
                                        </div>
                                        <p><small class="text-primary">It's your admin portal access path url. It only
                                                contains one word like admin or admincp</small></p>
                                    </div>
