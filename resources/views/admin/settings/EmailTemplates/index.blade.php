                            ...
                            <tr>
                                ...
                                <td>
                                    <div class='form-check form-switch form-check-primary'>
                                        <input type="checkbox" class="form-check-input get_status" id="{{ $template->uid }}" data-id="{{ $template->uid }}" name='status' @if($template->status == true) checked @endif>
                                        <label class="form-check-label" for="{{ $template->uid }}">
                                ...
                                <td>
                                    @can('update payment_gateways')
                                        <a href="{{ route('admin.email-templates.show', $template->uid) }}" class='text-primary'><i data-feather="settings"></i> {{__('locale.buttons.update')}}</a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
