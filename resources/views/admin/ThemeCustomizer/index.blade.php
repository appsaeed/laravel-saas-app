                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" action="{{ route('admin.theme.customizer') }}"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <select class="form-select" id="mainLayoutType" name="mainLayoutType">
                                            ...
                                            <option value="horizontal"
                                                {{ env('THEME_LAYOUT_TYPE') == 'horizontal' ? 'selected' : null }}>
                                                Horizontal
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <h4 class="mb-2 mt-1">Navbar menu toggle</h4>

                                {{-- language menu --}}
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label for="language_menu" class="form-check-label">Show langueage menu</label>
                                        <div class="form-switch me-3 me-lg-5 mt-1">
                                            <input type="checkbox" class="form-check-input" id="language_menu"
                                                @if (config('custom.menu.language_menu') == true) checked @endif value="true"
                                                name="language_menu">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label for="theme_switch_menu" class="form-check-label">Show Theme switch
                                            menu</label>
                                        <div class="form-switch me-3 me-lg-5 mt-1">
                                            <input type="checkbox" class="form-check-input" id="theme_switch_menu"
                                                @if (config('custom.menu.theme_switch') == true) checked @endif value="true"
                                                name="theme_switch_menu">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label for="notifye_menu" class="form-check-label">Show notification
                                            menu</label>
                                        <div class="form-switch me-3 me-lg-5 mt-1">
                                            <input type="checkbox" class="form-check-input" id="theme_switch_menu"
                                                @if (config('custom.menu.notifye_menu') == true) checked @endif value="true"
                                                name="notifye_menu">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label for="profile_menu" class="form-check-label">Show Theme switch
                                            menu</label>
                                        <div class="form-switch me-3 me-lg-5 mt-1">
                                            <input type="checkbox" class="form-check-input" id="profile_menu"
                                                @if (config('custom.menu.profile_menu') == true) checked @endif value="true"
                                                name="profile_menu">
                                        </div>
                                    </div>
                                </div>
