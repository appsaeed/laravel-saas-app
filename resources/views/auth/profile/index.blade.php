...
@section('content')
    ...
    <section class="users-edit">
        ...
        <ul class="nav nav-pills mb-2" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link @if ((old('tab') == 'account' || old('tab') == null) && request()->input('tab') == null) active @endif" id="account-tab" data-bs-toggle="tab"
            ...
            <li class="nav-item">
                <a class="nav-link {{ old('tab') == 'security' ? 'active' : null }}" id="security-tab" data-bs-toggle="tab"
                    href="#security" aria-controls="security" role="tab" aria-selected="true">
                    <i data-feather="lock"></i> {{ __('locale.labels.security') }}
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ request()->input('tab') == 'notification' ? 'active' : null }}" id="notification-tab"
                    data-bs-toggle="tab" href="#notification" aria-controls="notification" role="tab"
                    aria-selected="false">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane @if ((old('tab') == 'account' || old('tab') == null) && request()->input('tab') == null) active @endif" id="account"
            ...
            <div class="tab-pane {{ old('tab') == 'security' ? 'active' : null }}" id="security"
                aria-labelledby="security-tab" role="tabpanel">
                <!-- users edit Info form start -->
                @include('auth.profile._security')
                <!-- users edit Info form ends -->
            </div>

            <div class="tab-pane {{ request()->input('tab') == 'notification' ? 'active' : null }}" id="notification"
                aria-labelledby="notification-tab" role="tabpanel">
                <!-- users edit Info form start -->
            ...
            @if (config('app.two_factor') == true)
                <div class="tab-pane {{ old('tab') == 'two_factor' ? 'active' : null }}" id="two-factor"
                    aria-labelledby="two-factor-tab" role="tabpanel">
        ...
        $(document).ready(function() {
            ...
            Table.delegate(".action-delete", "click", function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ url('account/notifications/') }}" + '/' + id +
                                '/delete',
                            type: "POST",
                            data: {
                                _token: "{{ csrf_token() }}"
