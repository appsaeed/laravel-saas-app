                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.campaigns._addnew') }}" method="post" >
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="address" class="form-control" value="{{$extension->address}}" name="address" placeholder="Address">
                                            @error('address')
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label for="agent" class="form-label fs-4">Agent</label>
                                            <input type="text" id="agent" class="form-control" value="{{$extension->agent}}" name="agent" placeholder="Agent">
                                            @error('address')
                                                <p><small class="text-danger">{{ $message }}</small></p>
                                            @enderror
                                        </div>                                                
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label for="description" class="form-label fs-4">Property description</label>
                                            <textarea class="form-control" name="description" rows="4" id="message">{{$extension->description}}</textarea>
